    ...
    <>
      ...
      <div className="min-h-screen py-20 px-4">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex space-x-2 text-sm text-crisp-white/70">
              ...
              <li className="before:content-['/'] before:mr-2">
                <span aria-current="page" className="text-crisp-white">Services</span>
              </li>
            </ol>
          </nav>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-crisp-white/90 mb-8">
            Book your free consultation today to discuss your tattoo ideas and get expert advice. 
            Browse our <Link href="/gallery" className="text-gold hover:underline">portfolio gallery</Link> to 
            see examples of our work, or read about our <Link href="/aftercare" className="text-gold hover:underline">aftercare process</Link> to 
            understand how we ensure perfect healing.
          </p>
