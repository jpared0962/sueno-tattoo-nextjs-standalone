...
export const businessInfo = {
  ...
  description: "Professional independent tattoo artist Jose specializing in custom original designs, traditional American style, and realism work. Licensed & insured with 8+ years experience serving Laurel, MD and the DMV area.",
  ...
  artist: {
    ...
    credentials: "Licensed & Insured Professional"
  },
  ...
  // Social Media
  socialMedia: {
    instagram: "@suenotattoo",
    facebook: "facebook.com/suenotattoo",
    tiktok: "@suenotattoo",
    twitter: "@suenotattoo",
    youtube: "youtube.com/@suenotattoo",
  ...
  certifications: {
    ...
    contractorLicense: "Insured Professional",
